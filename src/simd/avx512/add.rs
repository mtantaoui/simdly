...
use crate::simd::avx512::f32x16::{self, F32x16};
...
fn simd_add(a: &[f32], b: &[f32]) -> Vec<f32> {
    ...
    let mut c = alloc_uninit_f32_vec(size, f32x16::AVX_ALIGNMENT);
